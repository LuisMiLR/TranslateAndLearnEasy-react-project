  ...
  return (
    <div>
      <div className=" bg-dark max-w-7xl mx-auto h-auto pb-16 mt-10 rounded-lg">
        <div className="flex flex-row bg-purple80 max-w-7xl mx-auto py-16 rounded-t-lg ">
          <div className="flex max-w-6xl mx-auto">
            <div className="pb-1  flex text-base">
        ...
        <section className="max-w-6xl  mx-auto h-auto py-3 px-6 my-8 rounded-lg bg-slader5 ">
          ...
          <div className="grid grid-cols-2 gap-x-1">
            <div className=" flex rounded-lg focus:outline-none">
              <input
                ...
                className=" bg-slader10 w-full h-48 pl-2 pb-10 rounded-lg  text-gray-100 text-justify focus:outline-none"
                value={inputText}
        ...
        <section className="max-w-6xl mx-auto flex justify-items-start">
          <div className=" flex flex-row justify-center h-30">
            <button className="bg-purple50 max-w-7xl h-14  mx-auto mr-4 flex  items-center p-3 rounded-lg text-base hover:opacity-80">
              <div className="bg-purple70 flex p-2 rounded-lg">
                <FaArrowUpRightDots size="2em" color="white" />
              </div>
              <p className="ml-2">Learn words</p>
            </button>
            <button className="bg-blue-600  opacity-80 max-w-7xl h-14 mx-auto mr-4 flex  items-center p-2 rounded-lg text-base hover:opacity-60">
              <div className="bg-blue-950 flex p-2 rounded-lg">
                <FaArrowUpZA size="2em" color="white" />
              </div>
              <p className="ml-2">Add to list</p>
            </button>
            <button className="bg-rankblue max-w-7xl h-14  mx-auto mr-4 flex  items-center p-3 rounded-lg text-base hover:opacity-80">
              <div className="bg-blue-950 flex p-2 rounded-lg">
                <FaArrowUpRightDots size="2em" color="white" />
              </div>
